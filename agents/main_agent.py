...
from tools.memory_tools import get_task_state, search_memory, write_memory
...
- search_memory: Search past summaries and facts by semantic similarity
...
async def run_agent(prompt: str, deps: AgentDeps) -> str:
